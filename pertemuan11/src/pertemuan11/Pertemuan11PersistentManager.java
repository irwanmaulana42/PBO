...
public class Pertemuan11PersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Pertemuan11";
	...
	private Pertemuan11PersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new Pertemuan11PersistentManager();
		}
